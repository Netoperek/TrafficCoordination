...
\begin{figure}[H]
  \includegraphics[width=1.0\textwidth]{execution_time_10_cars_4_roads.png}
...
\end{figure}
\begin{figure}[H]
  \includegraphics[width=1.0\textwidth]{execution_time_12_cars_4_roads.png}
...
\begin{figure}[H]
    \includegraphics[width=1.0\textwidth]{execution_time_10_cars_8_roads.png}
  \caption{wykres zależności czasu wykonania programu od liczby pojazdów (dla 2-10 pojazdów)}
  \label{execution_time_10_cars_8_roads}
\end{figure}
\begin{figure}[H]
    \includegraphics[width=1.0\textwidth]{execution_time_12_cars_8_roads.png}
  \caption{wykres zależności czasu wykonania programu od liczby pojazdów (dla 12 pojazdów)}
